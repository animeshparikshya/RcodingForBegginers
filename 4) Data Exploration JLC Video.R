...
#it is a assessment of the quality and characteristics of 
#data available to tackle business problems

#Data Exploration --> Data Extraction, Integration, Assessment

#6 steps in data exploration
#1. Transform qualitative data into quantitative data
#2. Generate derived variables
#3. Summary stats
#4. Cross tabulation - look at across variable for relationship
#5. Graphical analysis
#6. Anomaly detection
setwd("C:/Users/Animesh.Parikshya/Documents/IIM Classes/R Classes/Dataset")
cr<-read.csv("Credit.csv",na.strings=c("",NA))
library(dplyr)
options(scipen=999) #switch off scientific notation of number
##Data Exploration##
...
cr<-cr[,-c(1,12)]
cr$Good_Bad <- factor(cr$Good_Bad)
